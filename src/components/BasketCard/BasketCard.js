...
const BasketCard = ({
  ...
  return (
    <li className="basket__item guitar">
      <button className="guitar__delete" type="button" aria-label="кнопка удаления гитары">
      ...
      <div className="guitar__buttons">
        <button className="guitar__button guitar__button_type_less" type="button">-</button>
        <p className="guitar__quantity"></p>
        <button className="guitar__button guitar__button_type_more" type="button">+</button>
      </div>
      <p className="guitar__full-price"><span className="guitar__full-price-content"></span> ₽</p>
    </li>
  )
}
